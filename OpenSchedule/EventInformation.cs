...
namespace OpenSchedule
{
    public class EventInformation : IComparable,ICloneable
    {
        ...
        /// <param name="duration">the duration of the event
        /// <param name="EventId">the hash of the event
        /// </param>
        ...
        public int CompareTo(object obj)
        {
            ...
            if (obj is EventInformation otherEventInformation)
                return this.StartTime.CompareTo(otherEventInformation.StartTime);
            else
        ...
        public Object Clone()
        {
            return new EventInformation(this.Classroom,this.StartTime,this.EventDuration,this.EventId) as Object;
        }
    }
}
